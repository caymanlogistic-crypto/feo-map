...
<div class="selection-panel" id="selection-panel">
    ...
    <div class="hint">Вводите ID через запятую или Enter</div>
...
<div class="flight-modal-backdrop" id="flightEditModal" style="display:none;">
    <div class="flight-modal">
        ...
        <label class="flight-modal-label" for="edit_planned_start_date_from">planned_start_date_from</label>
        <input class="flight-modal-input" type="datetime-local" id="edit_planned_start_date_from">
        <label class="flight-modal-label" for="edit_planned_start_date_to">planned_start_date_to</label>
        <input class="flight-modal-input" type="datetime-local" id="edit_planned_start_date_to">
        <label class="flight-modal-label" for="edit_driver_id">Водитель</label>
        ...
        <div class="flight-modal-actions">
            <button class="route-action-btn route-transfer-btn" id="flightEditTransferFoundBtn">➡️ Исполнит. найден</button>
...
<div class="flight-modal-backdrop" id="startConfirmModal" style="display:none;">
    <div class="flight-modal">
        <div class="flight-modal-title">Перевести в "Вывоз начался"</div>
        ...
        <div class="flight-modal-actions">
            <button class="route-action-btn route-transfer-start-btn" id="startConfirmBtn">▶️ Подтвердить</button>
